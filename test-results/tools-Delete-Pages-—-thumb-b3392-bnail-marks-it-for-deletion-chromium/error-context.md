...
- Name: tools.spec.ts >> Delete Pages — thumbnail selection >> clicking a thumbnail marks it for deletion
- Location: tests/tools.spec.ts:149:7
...
Locator: locator('img[alt="Page 1"]').first()
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('img[alt="Page 1"]').first()
...
- main:
  - link "All tools":
    - /url: /
  - heading "Delete Pages" [level=1]
  - text: Organize
  - paragraph: Select the pages you want to remove, preview the result and download the trimmed document.
  - paragraph: test.pdf
  - paragraph: 0.00 MB
  - button "Change file"
  - paragraph: Pages
  ...
  - button "Page Numbers"
  - button "Split"
  - paragraph: Click a page number to mark it for deletion. Red = will be deleted.
  - button "1"
  - button "2"
  - button "3"
  - button "Delete pages" [disabled]
  - heading "Related Organize tools" [level=2]
  - link "Merge PDF Combine multiple PDF files into a single document.":
    - /url: /merge-pdf
