...
- Name: navigation.spec.ts >> Tool pages — all load without errors >> /compress-pdf shows coming soon
...
- main:
  ...
  - text: Convert
  - paragraph: Choose from three compression levels — Screen, eBook or Printer. Processed entirely in your browser; your file never leaves your device.
  - heading "Related Convert tools" [level=2]
  - link "PDF to Word Convert PDF to an editable Word document.":
    - /url: /pdf-to-word
