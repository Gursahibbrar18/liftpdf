...
- Name: navigation.spec.ts >> Tool pages — all load without errors >> /pdf-editor shows coming soon
...
- main:
  - link "All tools":
    - /url: /
  - heading "PDF Editor" [level=1]
  - text: Edit
  - paragraph: Click any text to edit it. Add images, draw shapes, insert links and annotate — all without converting your file.
  - heading "Related Edit tools" [level=2]
  - link "Whiteout PDF Cover sensitive content by painting over it in white.":
    - /url: /whiteout-pdf
