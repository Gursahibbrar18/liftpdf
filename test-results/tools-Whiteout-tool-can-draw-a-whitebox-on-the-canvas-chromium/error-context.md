...
- Name: tools.spec.ts >> Whiteout tool >> can draw a whitebox on the canvas
- Location: tests/tools.spec.ts:172:7
...
- main:
  - link "All tools":
    - /url: /
  - heading "Whiteout PDF" [level=1]
  - text: Edit
  - paragraph: Draw white rectangles over any content you want to hide. Perfect for redacting names, prices or private information before sharing.
  - paragraph: test.pdf
  - paragraph: 0.00 MB
  - button "Change file"
  - paragraph: Pages
  ...
  - button "Page Numbers"
  - button "Split"
  - paragraph: 0 whiteout areas drawn · Page 1 preview
  - paragraph: Click and drag on the page to draw a white rectangle over content you want to hide.
  - button "Apply & Download" [disabled]
  - heading "Related Edit tools" [level=2]
  - link "PDF Editor Edit text, images, links and shapes directly in your PDF.":
    - /url: /pdf-editor
  - link "Annotate PDF Highlight, strikethrough, underline and add sticky notes.":
    - /url: /annotate-pdf
  - link "Fill & Sign PDF Fill out PDF forms and add your signature.":
    - /url: /fill-sign-pdf
  - link "Find & Replace Search and replace text across your entire PDF.":
